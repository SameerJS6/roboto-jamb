...
// Variable: queryMainColumnData
// Query: *[_type == "mainColumn" && _id == "mainColumn"][0]{    _id,    _type,    _createdAt,    _updatedAt,    label,    headline,    title,    description,    backgroundColor,    image {        "id": asset._ref,  "preview": asset->metadata.lqip,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      alt    },    imageFill,    desktopLayoutDirection,    mobileLayoutDirection,    ctaLayout,      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.href    ),  }  }
export type QueryMainColumnDataResult = null;
